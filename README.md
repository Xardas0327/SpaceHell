...
- Show/Hide FPS: F
- Close the game: ESC
- Moving the Textboxes: ENTER

## License
- My Learning2DEngine v1.11 [License](https://github.com/Xardas0327/Learning2DEngine/blob/main/Documentations/Learning2DEngine.md#license)
- Sound Engine free [License](https://www.ambiera.com/irrklang/license.html)
...
- https://3rdechosounds.itch.io/action-game-sfx